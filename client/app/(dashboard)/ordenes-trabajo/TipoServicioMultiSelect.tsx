...
import { searchTiposServicio } from '../../lib/ordenes-trabajo';
...
export default function TipoServicioMultiSelect({
  ...
  // add, not ones already attached to the orden de trabajo.
          ...
          >
            <div className="border-b border-stone-200 p-2">
              <input
                ...
                placeholder="Buscar..."
                className="block w-full rounded-lg border border-stone-200 bg-stone-50 px-3 py-2 text-sm text-stone-900 focus:border-rose-400 focus:outline-none focus:ring-2 focus:ring-rose-100"
              />
            </div>
