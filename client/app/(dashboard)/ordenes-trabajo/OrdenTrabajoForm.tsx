...
interface OrdenTrabajoFormProps {
  mode: 'create' | 'edit';
  initialValues: OrdenTrabajoFormValues;
  submitting: boolean;
  submitLabel: string;
  submittingLabel: string;
  cancelHref: string;
  onSubmit: (payload: UpdateOrdenTrabajoPayload) => void | Promise<void>;
}
...
function serializeForm(values: OrdenTrabajoFormValues): string {
...
/**
 * Shared create/edit form for `OrdenTrabajo` (design.md § Frontend
...
export default function OrdenTrabajoForm({
  ...
  const [form, setForm] = useState<OrdenTrabajoFormValues>(initialValues);
  ...
  const updateField = <K extends keyof OrdenTrabajoFormValues>(
    field: K,
  ...
  const handleSubmit = (event: FormEvent<HTMLFormElement>) => {
    ...
    const payload: CreateOrdenTrabajoPayload = {
